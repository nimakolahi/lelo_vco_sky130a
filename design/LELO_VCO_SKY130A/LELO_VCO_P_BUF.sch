...
C {LELO_VCO_SKY130A/LELO_PCH_4p8x0p18.sym} 400 0 0 0 {name=XXM22}
N 440.0 50.0 440.0 30.0 {lab=Vout}
C {devices/lab_pin.sym} 440.0 50.0 1 0 {name=l0 sig_type=std_logic lab=Vout }
...
C {LELO_VCO_SKY130A/LELO_PCH_4p8x0p18.sym} 400 170 0 0 {name=XXM23}
N 440.0 220.0 440.0 200.0 {lab=net19}
C {devices/lab_pin.sym} 440.0 220.0 1 0 {name=l4 sig_type=std_logic lab=net19 }
