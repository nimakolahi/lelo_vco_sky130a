...
C {devices/iopin.sym} 0 20 0 0 {name=p1 lab=net14}
C {devices/iopin.sym} 0 40 0 0 {name=p2 lab=net17}
C {devices/iopin.sym} 0 60 0 0 {name=p3 lab=net6}
C {LELO_VCO_SKY130A/LELO_NCH_0p96x0p36.sym} 400 0 0 0 {name=XXM14}
N 440.0 -50.0 440.0 -30.0 {lab=net7}
C {devices/lab_pin.sym} 440.0 -50.0 3 0 {name=l0 sig_type=std_logic lab=net7 }
...
C {LELO_VCO_SKY130A/LELO_NCH_2p4x0p54.sym} 400 170 0 0 {name=XXM4}
N 440.0 120.0 440.0 140.0 {lab=net6}
C {devices/lab_pin.sym} 440.0 120.0 3 0 {name=l4 sig_type=std_logic lab=net6 }
N 380.0 170.0 400.0 170.0 {lab=net14}
C {devices/lab_pin.sym} 380.0 170.0 0 0 {name=l5 sig_type=std_logic lab=net14 }
N 440.0 220.0 440.0 200.0 {lab=net7}
C {devices/lab_pin.sym} 440.0 220.0 1 0 {name=l6 sig_type=std_logic lab=net7 }
